...
{
    public class Travis_Bot : AbstractBot, IBot
    {
        protected static Travis_BotScriptor m_pScript = Travis_BotScriptor.Instance();

        public Travis_Bot(Raven_Game world, Vector2 pos) :
            base(world, pos)
        {
            m_pScript = Travis_BotScriptor.Instance();
            ...
            m_pSteering = new Travis_BotSteering(world, this);
            ...
            m_pTargSys = new Travis_TargetingSystem(this);

            m_pWeaponSys = new Travis_WeaponSystem(this,
