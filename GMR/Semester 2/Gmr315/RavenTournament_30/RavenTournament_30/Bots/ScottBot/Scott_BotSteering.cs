...
{
    public class Scott_BotSteering : AbstractSteering
    {


        public Scott_BotSteering(Raven_Game world, AbstractBot agent)
            : base(world, agent)
        {
            Scott_BotScriptor myScript = Scott_BotScriptor.Instance();
