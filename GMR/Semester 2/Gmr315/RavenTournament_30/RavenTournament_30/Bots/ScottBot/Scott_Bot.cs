...
{
    public class Scott_Bot : AbstractBot, IBot
    {
        protected static Scott_BotScriptor m_pScript = Scott_BotScriptor.Instance();

        public Scott_Bot(Raven_Game world, Vector2 pos) :
            base(world, pos)
        {
            m_pScript = Scott_BotScriptor.Instance();
            ...
            m_pSteering = new Scott_BotSteering(world, this);
            ...
            m_pTargSys = new Scott_TargetingSystem(this);

            m_pWeaponSys = new Scott_WeaponSystem(this,
