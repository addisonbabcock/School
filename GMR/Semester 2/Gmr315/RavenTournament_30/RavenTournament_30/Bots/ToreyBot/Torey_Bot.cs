...
{
    public class Torey_Bot : AbstractBot, IBot
    {
        protected static Torey_BotScriptor m_pScript = Torey_BotScriptor.Instance();

        public Torey_Bot(Raven_Game world, Vector2 pos) :
            base(world, pos)
        {
            m_pScript = Torey_BotScriptor.Instance();
            ...
            m_pSteering = new Torey_BotSteering(world, this);
            ...
            m_pTargSys = new Torey_TargetingSystem(this);

            m_pWeaponSys = new Torey_WeaponSystem(this,
