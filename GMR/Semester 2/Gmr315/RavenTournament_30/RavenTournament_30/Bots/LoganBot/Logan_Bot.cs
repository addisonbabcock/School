...
{
    public class Logan_Bot : AbstractBot, IBot
    {
        protected static Logan_BotScriptor m_pScript = Logan_BotScriptor.Instance();

        public Logan_Bot(Raven_Game world, Vector2 pos) :
            base(world, pos)
        {
            m_pScript = Logan_BotScriptor.Instance();
            ...
            m_pSteering = new Logan_BotSteering(world, this);
            ...
            m_pTargSys = new Logan_TargetingSystem(this);

            m_pWeaponSys = new Logan_WeaponSystem(this,
