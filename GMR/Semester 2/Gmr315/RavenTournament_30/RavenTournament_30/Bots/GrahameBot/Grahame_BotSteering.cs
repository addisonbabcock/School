...
{
    public class Grahame_BotSteering : AbstractSteering
    {


        public Grahame_BotSteering(Raven_Game world, AbstractBot agent)
            : base(world, agent)
        {
            Grahame_BotScriptor myScript = Grahame_BotScriptor.Instance();
