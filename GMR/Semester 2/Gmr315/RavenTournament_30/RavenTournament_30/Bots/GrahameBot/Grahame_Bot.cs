...
{
    public class Grahame_Bot : AbstractBot, IBot
    {
        protected static Grahame_BotScriptor m_pScript = Grahame_BotScriptor.Instance();

        public Grahame_Bot(Raven_Game world, Vector2 pos) :
            base(world, pos)
        {
            m_pScript = Grahame_BotScriptor.Instance();
            ...
            m_pSteering = new Grahame_BotSteering(world, this);
            ...
            m_pTargSys = new Grahame_TargetingSystem(this);

            m_pWeaponSys = new Grahame_WeaponSystem(this,
