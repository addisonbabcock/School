...
{
    public class Raven_Bot : AbstractBot, IBot
    {
        protected static Raven_BotScriptor m_pScript = Raven_BotScriptor.Instance();

        public Raven_Bot(Raven_Game world, Vector2 pos) :
            base(world, pos)
        {
