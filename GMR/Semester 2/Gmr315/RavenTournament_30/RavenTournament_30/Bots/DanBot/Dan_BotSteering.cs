...
{
    public class Dan_BotSteering : AbstractSteering
    {


        public Dan_BotSteering(Raven_Game world, AbstractBot agent)
            : base(world, agent)
        {
            Dan_BotScriptor myScript = Dan_BotScriptor.Instance();
