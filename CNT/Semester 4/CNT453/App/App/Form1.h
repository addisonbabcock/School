...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button1->Text = L"Check da box!";
			...
			this->checkBox1->Location = System::Drawing::Point(47, 77);
			...
			this->button2->Size = System::Drawing::Size(85, 52);
			this->button2->TabIndex = 2;
			this->button2->Text = L"Make the other button disappear";
			this->button2->UseVisualStyleBackColor = true;
			this->button2->Click += gcnew System::EventHandler(this, &Form1::button2_Click);
			// 
			// button3
			// 
			this->button3->Location = System::Drawing::Point(138, 167);
			this->button3->Name = L"button3";
			this->button3->Size = System::Drawing::Size(75, 53);
			this->button3->TabIndex = 3;
			this->button3->Text = L"I don\'t do anything";
