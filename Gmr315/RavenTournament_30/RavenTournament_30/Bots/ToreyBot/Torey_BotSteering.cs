...
{
    public class Torey_BotSteering : AbstractSteering
    {


        public Torey_BotSteering(Raven_Game world, AbstractBot agent)
            : base(world, agent)
        {
            Torey_BotScriptor myScript = Torey_BotScriptor.Instance();
