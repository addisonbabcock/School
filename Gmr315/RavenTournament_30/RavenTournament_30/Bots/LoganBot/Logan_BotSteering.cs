...
{
    public class Logan_BotSteering : AbstractSteering
    {


        public Logan_BotSteering(Raven_Game world, AbstractBot agent)
            : base(world, agent)
        {
            Logan_BotScriptor myScript = Logan_BotScriptor.Instance();
