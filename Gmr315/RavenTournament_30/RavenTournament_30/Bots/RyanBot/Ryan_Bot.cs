...
{
    public class Ryan_Bot : AbstractBot, IBot
    {
        protected static Ryan_BotScriptor m_pScript = Ryan_BotScriptor.Instance();

        public Ryan_Bot(Raven_Game world, Vector2 pos) :
            base(world, pos)
        {
            m_pScript = Ryan_BotScriptor.Instance();
            ...
            m_pSteering = new Ryan_BotSteering(world, this);
            ...
            m_pTargSys = new Ryan_TargetingSystem(this);

            m_pWeaponSys = new Ryan_WeaponSystem(this,
