...
{
    public class Ryan_BotSteering : AbstractSteering
    {


        public Ryan_BotSteering(Raven_Game world, AbstractBot agent)
            : base(world, agent)
        {
            Ryan_BotScriptor myScript = Ryan_BotScriptor.Instance();
