...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
; LCDCreate																	;
;	Purpose		: Loads the custom character data into the LCD				;
;	Modifies	: LCD display (possibly), LCD custom characters				;
;	Accepts		: The address of the start of the character data in X.		;
;				  How many characters to load in bytes (1 char = 8 bytes) 	;
;				  in Acc B													;
;	Return		: Nothing													;
;	Last mod	: 08/30/2007												;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
LCDCreate:
				...
				jsr		LCDGoCGData
LCDCreate_MoreBytes:
				cmpb	#0				;Check for more bytes to write
				beq		LCDCreate_Done
				decb
				ldaa	0,x				;load a byte
				jsr		LCDSetChar		;send it to the LCD
				inx						;go to the next byte
				bra		LCDCreate_MoreBytes
LCDCreate_Done:
				pulx					;clean up
				pulb
				pula
