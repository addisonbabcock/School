...
loop:			
				jsr		adc_sample			;grab a sample
				
				staa	LED					;show the hex value on the LED
				
				;next we will be outputting that same voltage on the DAC
				;so we will need to scale the 8bit input voltage to the
				;12bit capability of the DAC
				;this will be done by shifting the input by 1 nibble
				tab
				lsra
				lsra
				lsra
